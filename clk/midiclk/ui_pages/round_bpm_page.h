...
#ifndef MIDICLK_UI_PAGES_CLK_ROUND_BPM_PAGE_H_
#define MIDICLK_UI_PAGES_CLK_ROUND_BPM_PAGE_H_

#include "midiclk/ui_pages/ui_page.h"

namespace midiclk {

class RoundBpmPage : public UiPage {
 public:
  RoundBpmPage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(RoundBpmPage);
};

}  // namespace midiclk

#endif  // MIDICLK_UI_PAGES_CLK_ROUND_BPM_PAGE_H_
