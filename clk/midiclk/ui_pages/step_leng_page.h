...
#ifndef MIDICLK_UI_PAGES_CLK_STEP_LENG_PAGE_H_
#define MIDICLK_UI_PAGES_CLK_STEP_LENG_PAGE_H_

#include "midiclk/ui_pages/ui_page.h"

namespace midiclk {

class StepLengPage : public UiPage {
 public:
  StepLengPage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(StepLengPage);
};

}  // namespace midiclk

#endif  // MIDICLK_UI_PAGES_CLK_STEP_LENG_PAGE_H_
