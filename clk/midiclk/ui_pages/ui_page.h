...
#ifndef MIDICLK_UI_PAGES_UI_PAGE_H_
#define MIDICLK_UI_PAGES_UI_PAGE_H_
...
class UiPage {
 ...
 protected:
  ...
  static uint8_t CheckIdleShiftAction();
  ...
  static int16_t Round(double x);
  static double Scale(double x0, double x0min, double x0max, double x1min, double x1max);
...
#endif  // MIDICLK_UI_PAGES_UI_PAGE_H_
