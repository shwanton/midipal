...
#ifndef MIDICLK_UI_PAGES_CLK_HOLD_MODE_PAGE_H_
#define MIDICLK_UI_PAGES_CLK_HOLD_MODE_PAGE_H_

#include "midiclk/ui_pages/ui_page.h"

namespace midiclk {

class HoldModePage : public UiPage {
 public:
  HoldModePage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(HoldModePage);
};

}  // namespace midiclk

#endif  // MIDICLK_UI_PAGES_CLK_HOLD_MODE_PAGE_H_
