...
#ifndef MIDICLK_UI_PAGES_CLK_PASS_THRU_PAGE_H_
#define MIDICLK_UI_PAGES_CLK_PASS_THRU_PAGE_H_

#include "midiclk/ui_pages/ui_page.h"

namespace midiclk {

class PassThruPage : public UiPage {
 public:
  PassThruPage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(PassThruPage);
};

}  // namespace midiclk

#endif  // MIDICLK_UI_PAGES_CLK_PASS_THRU_PAGE_H_
