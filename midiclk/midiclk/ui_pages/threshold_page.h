...
#ifndef MIDICLK_UI_PAGES_CLK_THRESHOLD_PAGE_H_
#define MIDICLK_UI_PAGES_CLK_THRESHOLD_PAGE_H_

#include "midiclk/ui_pages/ui_page.h"

namespace midiclk {

class ThresholdPage : public UiPage {
 public:
  ThresholdPage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(ThresholdPage);
};

}  // namespace midiclk

#endif  // MIDICLK_UI_PAGES_CLK_THRESHOLD_PAGE_H_
