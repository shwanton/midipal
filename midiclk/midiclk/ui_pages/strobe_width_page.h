...
#ifndef MIDICLK_UI_PAGES_CLK_STROBE_WIDTH_PAGE_H_
#define MIDICLK_UI_PAGES_CLK_STROBE_WIDTH_PAGE_H_

#include "midiclk/ui_pages/ui_page.h"

namespace midiclk {

class StrobeWidthPage : public UiPage {
 public:
  StrobeWidthPage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(StrobeWidthPage);
};

}  // namespace midiclk

#endif  // MIDICLK_UI_PAGES_CLK_STROBE_WIDTH_PAGE_H_
