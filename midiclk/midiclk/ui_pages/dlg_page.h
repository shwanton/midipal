...
#ifndef MIDICLK_UI_PAGES_DLG_PAGE_H_
#define MIDICLK_UI_PAGES_DLG_PAGE_H_

#include "midiclk/ui_pages/ui_page.h"

namespace midiclk {

class DlgPage : public UiPage {
 public:
  DlgPage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(DlgPage);
};

}  // namespace midiclk

#endif  // MIDICLK_UI_PAGES_DLG_PAGE_H_
