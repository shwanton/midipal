...
#ifndef MIDICLK_UI_PAGES_CLK_STEP_NUMB_PAGE_H_
#define MIDICLK_UI_PAGES_CLK_STEP_NUMB_PAGE_H_

#include "midiclk/ui_pages/ui_page.h"

namespace midiclk {

class StepNumbPage : public UiPage {
 public:
  StepNumbPage() { }
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(StepNumbPage);
};

}  // namespace midiclk

#endif  // MIDICLK_UI_PAGES_CLK_STEP_NUMB_PAGE_H_
